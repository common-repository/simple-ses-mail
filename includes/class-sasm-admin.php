                                ...
                                <?php }else{ ?>
                                    ...
                                    <form action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" method="post" id="nds_add_user_meta_form" >          
                                        ...
                                        <div>
                                            ...
                                            <input required type="password" name="sasm-key" placeholder="Enter AWS Access Key" />
                                        </div>

                                        <div>
                                            <label for="secret"> <?php _e('AWS Secret Key', 'simple-aws-ses-mail'); ?> </label><br>
                                            <input required type="password" name="sasm-secret" placeholder="Enter AWS Secret Key" />
                                        </div>
